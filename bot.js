...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexDaf = /^\/dafuq/; botRegexMA32 = /^\/pending/; botRegexTrade = /^\/trade/; botRegexDL = /^\/DL/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://daddyleagues.com/sndv20");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("www.daddyleagues.com/sndv20/");
    this.res.end();
  } 
